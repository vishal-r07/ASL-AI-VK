...
class OptimizedASLDetector:
    ...
    Args:
        ...
        mirror_output (bool): If True, output video is mirrored (selfie-view). If False, output matches real hand orientation.
    """
    
    def __init__(self, model_name="asl_model_optimized.h5", confidence_threshold=0.9, mirror_output=True):
    ...
    def process_frame(self, frame):
        ...
        # Flip the frame horizontally for a later selfie-view display if mirror_output is True
        ...
        # Annotated output should match the mirror setting
        if self.mirror_output:
